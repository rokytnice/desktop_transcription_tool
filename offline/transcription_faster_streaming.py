...
MIN_CHUNK = float(os.environ.get('STREAM_MIN_CHUNK', '1.0'))     # s
...
class OnlineASRProcessor:
    ...
    def finish(self):
        """Commit any remaining un-confirmed words when streaming stops."""
        remaining = self.hyp.complete()
        return [t for _a, _b, t in remaining]
...
Tipp:
  Auf CPU für flüssiges Streaming ein kleines Modell verwenden:
